...
/** 
 * ClassName:UserGroupRoleRelation <br/> 
 * Function: 用户组角色映射表. <br/> 
 * Reason:   用户组角色映射表. <br/> 
...
public class UserGroupRoleRelation implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UserGroupRoleRelation other = (UserGroupRoleRelation) obj;
		if (userGroup == null) {
	...
	public String toString() {
		return "UserGroupRoleRelation [id=" + id + ", userGroup=" + userGroup + ", role=" + role+ "]";
	}
}