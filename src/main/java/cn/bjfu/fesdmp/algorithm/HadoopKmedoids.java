...
public  class HadoopKmedoids  extends Configured implements Tool {
	...
	public HadoopKmedoids() {

	}
	public HadoopKmedoids(DataJson[][] dataJson, int k) {
		this.k = k;
...
//        conf.addResource(new Path(path + "mapred-site.xml"));
	...
	public List comput()  throws Exception{
		...
		while (centerchange) {
			...
			int res=ToolRunner.run(new Configuration(),new HadoopKmedoids(),location);
